...
window.onload = function() {
  ...
  function process(vars) {
    ...
    //xz页面上的斜边长
    var hypotenuse_xz = Math.sqrt(
      vars.camX * vars.camX + vars.camZ * vars.camZ
    );
  ...
  function createFrame() {
    ...
    newVars.camZ = -14;
    newVars.pitch =
      elevation(newVars.camX, newVars.camZ, newVars.camY) - Math.PI / 2;
    newVars.yaw = 0;
    newVars.bounding = 10;
    newVars.scale = 500;
    newVars.floor = 26.5;
  ...
  number.onfocus = function() {
    if (number.value == "Administrator") {
      ...
      numberSpan.innerHTML =
        " <font color='buff' size='1'>账号:Administrator</font>";
    }
  };
  number.onblur = function() {
    if (number.value == "") {
      ...
      numberSpan.innerHTML = numberSpan.innerHTML =
        "<font color='red' size='2'>×账号错误</font>";
    }
  };
  // 密码验证
  password.onfocus = function() {
    if (password.value == "452566060") {
      ...
      passwordSpan.innerHTML =
        " <font color='buff' size='2'>密码:452566060</font>";
    }
  };
  ...
  var analy = function() {
    ...
    ps[0].innerHTML = "";
    ps[1].innerHTML =
      "<h4 style='color:coral'><center>您可以把光标放在输入框里根据提示登录或者您的时间宝贵直接点击一键登录</center></h4>";
    ps[2].innerHTML =
      "<h4 style='color:coral'><center>有问题请点击下方的\"点我联系管理员\"</center></h4>";
  };
  ...
  function point(analysis) {
    ...
    modal.style.display = "block";
    h2.innerHTML =
      "<h5 style='color:#000'>登录失败 原因:<span style='color:red'>" +
      analysis +
      "</span></h5>";
    ps[0].innerHTML = "";
    ps[1].innerHTML =
  ...
  submit.onclick = function() {
    if (
      ...
      window.open("https://lvdegao.github.io/April/April.html");
      event.preventDefault();
